...
shapes_path = 'immersions_scalogram_resnet_house_smaller_activation_shapes.p'
...
#              ('prediction', [16, 512])])
#
# with open('immersions_scalogram_resnet_house_smaller_activation_shapes_log.p', 'wb') as handle:
